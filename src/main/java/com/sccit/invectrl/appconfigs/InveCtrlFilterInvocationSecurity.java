 ...
 */
@Service
public class InveCtrlFilterInvocationSecurity implements FilterInvocationSecurityMetadataSource {

    private static final Logger log = LoggerFactory.getLogger(InveCtrlFilterInvocationSecurity.class);
